...
Undertook this role deliberately to build ground-level domain expertise in actuarial risk, underwriting, and insurance product design — areas directly relevant to research in Financial AI and InsurTech. Working at the client-facing layer of the insurance value chain has provided practical insight into where current models fall short and where AI-driven approaches could add meaningful value.  
...
- Developed and monitored KPIs to track business performance, consumer behaviour, and emerging trends, giving leadership teams a clearer basis for data-driven decisions.
